...
| asken-myfitnesspal-sync | あすけん → MyFitnessPal 食事データ同期 | 毎時0分 + 毎日23:59 JST |
...
```
EventBridge Scheduler (毎時0分 + 毎日23:59 JST)
         │
         ▼
...
```bash
aws scheduler get-schedule --name asken-myfitnesspal-sync-hourly --region ap-northeast-1
...
```json
{
  "asken_email":          "your-email@example.com",
  "asken_password":       "your-password",
  "myfitnesspal_email":   "your-mfp-email@example.com",
  "myfitnesspal_password": "your-mfp-password"
}
```
